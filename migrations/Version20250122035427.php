 ...
 */
final class Version20250122035427 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE expense_entity ADD subcategory_entity_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE expense_entity DROP subcategory_entity_id');
    }
}
