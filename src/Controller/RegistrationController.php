...
//            dd($user->getId());
            ...
            $this->emailVerifier->sendEmailConfirmation('app_verify_email', $user,
                (new TemplatedEmail())
                    ->from(new Address('verification@Le-Bon-Compte.com', 'Le Bon Compte'))
    ...
    public function verifyUserEmail(Request $request, TranslatorInterface $translator, UserEntityRepository $userEntityRepository): Response
    {
