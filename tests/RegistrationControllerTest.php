...
class RegistrationControllerTest extends WebTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->userRepository = $container->get(UserEntityRepository::class);
    ...
    public function testRegister(): void
    {
        ...
        self::assertEmailAddressContains($messages[0], 'from', 'verification@Le-Bon-Compte.com');
        ...
        self::assertTrue(static::getContainer()->get(UserEntityRepository::class)->findAll()[0]->isVerified());
    }
}
